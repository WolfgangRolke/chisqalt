...
ggsave(
  paste0(getwd(), "/Computational Statistics/Fig1.png"))
ggsave(
  paste0(getwd(), "/Computational Statistics/Fig1.eps"))
```
...
ggsave(
  paste0(getwd(), "/Computational Statistics/Fig2a.eps"))
...
ggsave(
  paste0(getwd(), "/Computational Statistics/Fig2b.eps"))
```
...
ggsave(paste0(getwd(), 
              "/Computational Statistics/Fig3.eps"))
out
all.cases <- out
```
...
ggsave(
  paste0(getwd(), "/Computational Statistics/Fig4.eps"))
out
...
ggsave(
  paste0(getwd(), "/Computational Statistics/Fig5.eps"))
out
all.cases <- rbind(all.cases, out)
```
...
ggsave(
  paste0(getwd(), "/Computational Statistics/Fig6.eps"))
out
all.cases <- rbind(all.cases, out)
```
...
ggplot(data=df, 
  ...
  scale_shape_manual(values=custom.shape)
ggsave(
  paste0(getwd(), "/Computational Statistics/Fig7.pdf"))
ggsave(
  paste0(getwd(), "/Computational Statistics/Fig7.eps"))
out
all.cases <- rbind(all.cases, out)
```

```{r}
opt.chisq.power(case)
```
...
ggplot(data=df, 
  ...
  scale_shape_manual(values=custom.shape)
ggsave(
  paste0(getwd(), "/Computational Statistics/Fig8.pdf"))
ggsave(
  paste0(getwd(), "/Computational Statistics/Fig8.eps"))
out
all.cases <- rbind(all.cases, out)
```
...
ggplot(data=df, 
  ...
  scale_shape_manual(values=custom.shape)
ggsave(
  paste0(getwd(), "/Computational Statistics/Fig9.pdf"))
ggsave(
  paste0(getwd(), "/Computational Statistics/Fig9.eps"))
out
all.cases <- rbind(all.cases, out)
```
...
case <- make.case(case)
out <- opt.chisq.power(case)$power
```
...
case <- make.case(case)
tmp <- opt.chisq.power(case)$power
